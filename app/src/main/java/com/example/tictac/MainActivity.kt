...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun disable(){ //ღილაკებს რომ არ დაეჭიროს ესე გავწერე და მერე disable()-ს ვიძახებ.ყოველჯერზე ახლიდან,რომ არ მეწერა
    ...
    private fun scoreReset(){ //ანგარიშს ანულებს
        points1 = 0
        points2 = 0
